...
export type PMColumnType<T = any> = {
  ...
  // 选项数据源（存在 url 时自动请求并填充 options）
  optionsSource?: {
    key?: string
    url?: string
    method?: 'GET' | 'POST'
    params?: Record<string, any> | ((ctx: {
      values: Record<string, any>
      requestResults: Record<string, any>
    }) => Record<string, any>)
    transform?: (
      resp: any,
      ctx: {
    ...
    dependsOnRequests?: string[]
    debounceMs?: number
    cacheKey?: string | ((ctx: { values: Record<string, any> }) => string)
    immediate?: boolean
    manual?: boolean
    resetOnChange?: boolean
    onError?: (err: any, ctx: any) => void
    emptyAs?: { label: any; value: any }[]
  }
